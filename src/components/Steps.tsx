            ...
            return (
                <li key={step.name} className='relative overflow-hidden lg:flex-1 '>
                    <div className="">
                        ...
                        <span className={cn(index !== 0 ? "lg:pl-9" : "", "flex items-center px-6 py-4 text-sm font-semibold ")}>
                            <span className='flex-shrink-0'>
                                <img src={imgPath} alt="image path" className={cn("flex pointer-events-none h-20 w-20 object-contain items-center justify-center ", {
